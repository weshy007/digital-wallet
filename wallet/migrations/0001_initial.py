    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regDate', models.DateField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Wallet_customer', to='wallet.user')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Reward_customer', to='wallet.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Notifications_recipient', to='wallet.user')),
            ],
        ),
        migrations.CreateModel(
            name='Loan',
            fields=[
                ...
                ('guaranter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Loan_guaranter', to='wallet.user')),
